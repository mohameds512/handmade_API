                ...
                <form method="POST" action="{{route('purchases.vendors.update',$vendor->id)}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ $vendor->phone }}"  autocomplete="phone">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="tel" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ $vendor->code }}"  autocomplete="code">
